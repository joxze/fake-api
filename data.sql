...
--
-- Host: localhost    Database: fake_api
-- ------------------------------------------------------
...
CREATE TABLE `acquirer` (
  ...
  `migs_status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `acquirer` WRITE;
/*!40000 ALTER TABLE `acquirer` DISABLE KEYS */;
INSERT INTO `acquirer` VALUES (1,'BCA',1),(2,'Mandiri',0),(3,'BRI',1);
...
-- Dump completed on 2020-02-28  0:03:31
